...
#define gimli_TAG_MAC 0x08

static void gimli_core_u8(uint8_t state_u8[gimli_BLOCKBYTES]);
...
static inline void
gimli_tag_u8(uint8_t buf[gimli_BLOCKBYTES], uint8_t tag)
{
    buf[gimli_BLOCKBYTES - 1] ^= tag;
}
